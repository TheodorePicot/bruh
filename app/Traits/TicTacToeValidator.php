...
trait TicTacToeValidator
{
    ...
    {
        return filled($this->ticTacToeMatrix[$i][$j]) && $this->ticTacToeMatrix[$i][$j] != $this->currentPlayer && $this->ticTacToeMatrix[$i][$j] != 0;
    }

    private function currentSelectionIsAlreadyPickedByCurrentPlayer($i, $j)
    {
        return filled($this->ticTacToeMatrix[$i][$j]) && $this->ticTacToeMatrix[$i][$j] == $this->currentPlayer;
    }
